...
# from models.cupy_utils import Dtype, Stream, load_kernel
...
def test_aggregation_zeropad():
    ...
    y2 = (w.unsqueeze(2) * x2.unsqueeze(1)).sum(-3).view(n, head_num * c_x, out_height, out_width)
...
def test_aggregation_zeropad_ks1():
