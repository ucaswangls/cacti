...
class TimesAttention3D(nn.Module):
    ...
    def __init__(self, dim, num_heads, qkv_bias=False, qk_scale=None, attn_drop=0., proj_drop=0.,frames=8):
...
class SwinTransformerBlock3D(nn.Module):
    ...
    def __init__(self, dim, num_heads, window_size=(2,7,7), shift_size=(0,0,0),
                 ...
                 act_layer=nn.GELU, norm_layer=nn.LayerNorm, use_checkpoint=False,frames=8):
        super().__init__()
        self.dim = dim
        self.num_heads = num_heads
        self.window_size = window_size
        ...
        self.time_attn = TimesAttention3D(
            ...
            proj_drop=drop,
            frames=frames)
        self.conv_cat = nn.Conv3d(dim*2,dim,1)
